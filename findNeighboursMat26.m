function [NeighboursInd,multiply_weight] = findNeighboursMat26(Index,MatrixSize)
%%**************************************************************************
...
multiply_weight = sqrt(2)*ones(Nindex*26,1) ; 
multiply_weight(20*Nindex+1:end) = 1 ; 
multiply_weight = multiply_weight(valid_neighbours_Indices) ;
multiply_weight(temp<0,:) = []; 
end
